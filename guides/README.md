...
1. **[TUTORIAL.md](TUTORIAL.md)**
   ...
   - Feature walkthrough and examples

### Quick Reference

2. **[CHEAT-SHEET.md](CHEAT-SHEET.md)**
   - Quick reference for Emacs and ESS keybindings
   - Essential commands at a glance
   - macOS keybinding reminders
...
| Key | Action |
|-----|--------|
| <kbd>⌃</kbd> <kbd>g</kbd> | Cancel (when stuck!) |
| <kbd>⌃</kbd> <kbd>x</kbd> <kbd>⌃</kbd> <kbd>f</kbd> | Find file |
| <kbd>⌃</kbd> <kbd>x</kbd> <kbd>⌃</kbd> <kbd>s</kbd> | Save |
| <kbd>⌥</kbd> <kbd>x</kbd> | Execute command |
| <kbd>⌃</kbd> <kbd>c</kbd> <kbd>r</kbd> <kbd>r</kbd> | Insert Roxygen |
